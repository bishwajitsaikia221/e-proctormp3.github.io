...
function confirmationDelete(anchor)
{
   ...
   if(conf)
	...
	<?php require_once 'stu_add_sem1_process.php'; ?>
			...
			<?php
				while($row = $result->fetch_assoc()): ?>
					<tr>
						...
						<td>
							<a href="stu_add_sem1.php?edit=<?php echo $row['ID']; ?>"
							class="btn btn-info">Edit</a>
							<a href="stu_add_sem1_process.php?delete=<?php echo $row['ID']; ?>"
	...
	?>
		...
		<form action="stu_add_sem1_process.php" method="POST">
