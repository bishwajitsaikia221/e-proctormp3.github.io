...
function confirmationDelete(anchor)
{
   ...
   if(conf)
	...
	<?php require_once 'stu_add_sem3_process.php'; ?>
	...
	<!--<div class="row justify-content-center">-->
		<table class="table" border="2">
			<h3 align="center">STUDENT LIST FOR SEMESTER 3</h3>
			<thead>
				<tr>
					<th>ID</th>
					<th>USN</th>
			...
			<?php
				while($row = $result->fetch_assoc()): ?>
					<tr>
						...
						<td>
							<a href="stu_add_sem3.php?edit=<?php echo $row['ID']; ?>"
							class="btn btn-info">Edit</a>
							<a href="stu_add_sem3_process.php?delete=<?php echo $row['ID']; ?>"
	...
	?>
		...
		<form action="stu_add_sem3_process.php" method="POST">
